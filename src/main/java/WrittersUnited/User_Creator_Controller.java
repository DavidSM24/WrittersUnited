...
public class User_Creator_Controller {
	...
	private void create() {
		...
		if (result.get() == ButtonType.OK){
			...
			if(txt_username.getText().matches("")
			...
			else if(UserDAO.getByName(txt_username.getText())!=null
				...
				alert2.showAndWait();
					...
					User user=new User(txt_username.getText(),txt_mail.getText(),txt_password.getText(),code,false, new HashSet<Project>());
					UserDAO.save(user);
